import time
from resources.tools import form_prompt, generate_new_image, run_faceswap, get_compliment, enhance_faces,img_resize, deepfake_on_replicate
import asyncio

def brain(ear_q, speech_q,show_q, cfg):
    ...
    while True:
        ...
        if result == "sleep_mode":
            ...
            show_q.put("thinking")
            if cfg.local_faceswap:
                run_faceswap(extra_command=cfg.conda_sh_location)
            else:
                deepfake_on_replicate()
